...
<div class="w-full flex flex-col items-center justify-center mt-8 mx-12 mb-8">
    ...
    <ul class="list-decimal text-sm mx-8">
        ...
        <li>
            ...
            <strong>https://www.outlandish.land/</strong> ('Website'), including
            the related mobile site and mobile application (hereinafter referred
            to as 'Platform').
        </li>
        <li>
            The Platform is owned by Outlandish Land, a company incorporated
            under the Companies Act, 1956 with its registered office at A22,
            Shreedham Splendor, Anand Nagar Link Road, Mumbai - 400102
        ...
        <li>
            ...
            <ul class="list-decimal m-4">
                ...
                <li>
                    ...
                    and is not limited to the design, layout, look and
                    graphics..
                </li>
                <li>
                ...
                <li>
                    ...
                    Terms, or Indian or local laws that might apply to you. You
                    agree and acknowledge that website and the Services may
                ...
                <li>
                    ...
                    party. Notwithstanding anything contained in these Terms of
                    Use, the parties shall not be liable for any failure to
                    perform an obligation under these Terms if performance is
                ...
                <li>
                    ...
                    courts in <strong>Mumbai</strong> and
