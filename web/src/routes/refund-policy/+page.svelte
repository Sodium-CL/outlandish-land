...
<h2 class="text-base/7 font-semibold text-red-600">Terms &amp; Conditions</h2>
<div class="w-full flex flex-col items-center justify-center">
    <p class="text-xl md:text-2xl mx-8">
        ...
        https://www.outlandish.land/ ('Website'), including the related mobile
        site and mobile application (hereinafter referred to as 'Platform'). The
        Platform is owned by Outlandish Land, a company incorporated under the
        Companies Act, 1956 with its registered office at A22, Shreedham
        Splendor, Anand Nagar Link Road, Mumbai - 400102 (hereinafter referred
        ...
        that are applicable to the Platform for such transaction. By mere use of
        the Platform, You shall be contracting with the Platform Owner and these
        ...
        in Mumbai and Maharashtra. All concerns or communications relating to
