...
<div class="h-screen font-primary bg-orange-50">
    <ul class="h-1/10 flex flex-row items-center justify-between list-none">
        ...
        <li>
            <ul class="px-2 flex flex-row items-center justify-between">
